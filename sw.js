const CACHE = 'objetivos-spatial-v33';
const ASSETS = ['./', './index.html', './styles.css?v=33', './fluency-engine.js?v=33', './app.js?v=33', './cloud-config.js?v=21', './cloud-sync.js?v=33', './manifest.webmanifest?v=21', './assets/os-icon-v18-180.png', './assets/os-icon-v18-192.png', './assets/os-icon-v18-512.png'];
