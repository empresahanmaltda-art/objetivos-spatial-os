const CACHE = 'objetivos-spatial-v29';
const ASSETS = ['./', './index.html', './styles.css?v=29', './fluency-curriculum.js?v=29', './fluency-engine.js?v=29', './app.js?v=29', './cloud-config.js?v=21', './cloud-sync.js?v=29', './manifest.webmanifest?v=21', './assets/os-icon-v18-180.png', './assets/os-icon-v18-192.png', './assets/os-icon-v18-512.png'];
