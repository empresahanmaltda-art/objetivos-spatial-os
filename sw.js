const CACHE = 'objetivos-spatial-v26';
const ASSETS = ['./', './index.html', './styles.css?v=26', './app.js?v=26', './cloud-config.js?v=21', './cloud-sync.js?v=26', './manifest.webmanifest?v=21', './assets/os-icon-v18-180.png', './assets/os-icon-v18-192.png', './assets/os-icon-v18-512.png'];
